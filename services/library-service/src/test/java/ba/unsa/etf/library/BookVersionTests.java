...
import ba.unsa.etf.library.core.impl.BookVersionServiceImpl;
...
class BookVersionTests {
    ...
    @BeforeEach
    void setUp() {
        bookVersionEntity = new BookVersionEntity("123-456-789", null, true, false);
        bookVersionDto = new BookVersion("123-456-789", null, true, false);
    }
